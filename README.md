声明：这个项目前前后后总共花了两个星期左右的时间完成，所以功能不够完善。因为秋招的时候主要问实习项目，所以这个个人项目就没再更新完善。而且我以前没学过 Spring，以前会一点 PHP，Spring 还是实习之前花了一两星期简单学了一下，所以项目代码可能有点过于简单。因为我最近比较忙，所以近期没时间更新项目相关的说明以及配置文档。你们可以修改这个项目作为个人项目，不过配置相关的问题只好自己解决。
